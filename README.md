...
Once selected, the reconstruction results for the chosen ancestral chromosome are automatically rendered in the main visualization panel.
...
**(3)** Export to PDF button  
Exports the currently displayed visualization to a PDF file. When clicked, the PDF is automatically generated and downloaded.
...
**(8)** Adjacency score visualization  
